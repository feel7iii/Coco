...
var CocoSharedLibsModule = (function () {
    function CocoSharedLibsModule() {
    }
    return CocoSharedLibsModule;
}());
CocoSharedLibsModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.CocoSharedLibsModule = CocoSharedLibsModule;
