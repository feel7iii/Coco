...
var _1 = require("./");
var CocoAccountModule = (function () {
    function CocoAccountModule() {
    }
    return CocoAccountModule;
}());
CocoAccountModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.CocoAccountModule = CocoAccountModule;
